...
public:
	...
	inline const static int QUOTE = 12;
	inline const static int LCURLY = 13;
	inline const static int RCURLY = 14;
	inline const static int LBRACKET = 15;
	inline const static int RBRACKET = 16;
	inline const static int LPAREN = 17;
	inline const static int RPAREN = 18;
